...
public class backup_TypeShouru {
    ...
    private static backup_TypeShouru typeUtil;

    private backup_TypeShouru(Context context) {
    ...
    //程序启动时初始化
    public static backup_TypeShouru initType(Context context) {
        if (typeUtil == null) {
            return new backup_TypeShouru(context);
        }
        return typeUtil;
    }
