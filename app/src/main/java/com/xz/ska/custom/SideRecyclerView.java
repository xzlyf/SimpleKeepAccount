...
public class SideRecyclerView extends RecyclerView {
    ...
    public SideRecyclerView(@NonNull Context context) {
        super(context);
        init();
    }


    public SideRecyclerView(@NonNull Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    public SideRecyclerView(@NonNull Context context, @Nullable AttributeSet attrs, int defStyle) {
